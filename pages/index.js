...
const MainPage = (props) => {
	...
	return (
		<Layout title="George's Donut Shop">
			<Row>
				<DonutShop onAddDonut={addDonut} onRemoveDonut={remDonut} numDonuts={numDonuts} />
			</Row>
			<CheckoutForm price={getDonutPrice(numDonuts)} onSuccessfulCheckout={() => Router.push('/success')} />
		</Layout>
	);
};
